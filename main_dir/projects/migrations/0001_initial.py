    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team_name', models.CharField(default='makaki', max_length=40)),
                ('team_type', models.CharField(choices=[('solo_project', 'Solo Project'), ('group_project', 'Group Project')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='projects', to='projects.team')),
            ],
        ),
        migrations.CreateModel(
            name='TeamMember',
